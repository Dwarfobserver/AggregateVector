...
AV_DEFINE_TYPE(user::physics, pos, speed, acc, id);
...
AV_DEFINE_TYPE(person, name, age, likes_cpp);

struct movable {
    std::unique_ptr<int> ptr;
};
AV_DEFINE_TYPE(movable, ptr);
